...
import { UserNotes } from "./../Quest Details/userNotes";
    ...
    <>
      ...
      {sorted.current && (
        ...
        >
          ...
          <p>
            {returningPName.current.replace('"', "").replace('"', "")} has a
            total of {questPoints} Quest Points and has{" "}
            {remainingQuests.current?.length} quests you can do at this current
            time!
          </p>
        </div>
      )}
