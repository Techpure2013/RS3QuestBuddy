...
import QuestIcon from "./../../assets/QuestIconEdited.png";
                          ...
                          {quest.Requirements.map(
                            (requirement, requirementIndex) => {
                              ...
                              const hasSkill = skillLevels.some((value) => {
                                ...
                                const isSkillValid =
                                  !isNaN(skillValue) &&
                                  !isNaN(requirementValue);
                                const isTypeMatch =
                                  skillType === requirementType;
                              ...
                              return (
                                ...
                                >
                                  {!isNaN(firstPart) ||
                                  requirement === "None" ||
                                  Array.from(ignoredRequirements).some(
                                    (prefix) => requirement.startsWith(prefix)
                                  ) ? (
                                    <span
                                      style={{
              ...
              return isHighlight ? (
                <Stepper.Step
                  ...
                  styles={{
                    stepDescription: {
                      color:
                        active > index ? "#24BF58" : hasColor ? userColor : "",
                    },
                    stepLabel: {
